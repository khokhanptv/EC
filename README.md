...
## Câu 11: Stack và Heap khác nhau như thế nào?
...
## Câu 12: Vùng Data và BSS khác nhau như thế nào?
...
## Câu 13: Memory leak và memory fragmentation khác nhau như thế nào?
...
## Câu 14: Function pointer là gì và được dùng khi nào?
...
## Câu 15: Truyền tham trị và truyền tham chiếu khác nhau như thế nào?
...
## Câu 16: Trong C++, `class` và `struct` khác nhau ở điểm nào?
...
## Câu 17: Bốn tính chất chính của lập trình hướng đối tượng là gì?
...
## Câu 18: Overloading và overriding khác nhau như thế nào?
...
## Câu 19: Shallow copy và deep copy khác nhau như thế nào?
...
## Câu 20: Rule of Three trong C++ là gì?
...
## Câu 22: `unique_ptr`, `shared_ptr` và `weak_ptr` khác nhau như thế nào?
...
## Câu 23: Move semantics là gì? `std::move` có thực sự di chuyển dữ liệu không?
...
## Câu 24: Lvalue và rvalue khác nhau như thế nào?
...
## Câu 25: Vì sao destructor class cha cần là `virtual` khi dùng đa hình?
...
## Câu 26: Hàm thuần ảo và abstract class là gì?
...
## Câu 28: `static_cast` và `dynamic_cast` khác nhau như thế nào?
...
## Câu 29: Undefined, unspecified và implementation-defined behavior khác nhau thế nào?
...
## Câu 30: Rule of Five và Rule of Zero là gì?
...
## Câu 31: `const` và `constexpr` khác nhau như thế nào?
...
## Câu 32: Từ khóa `inline` có ý nghĩa gì?
...
## Câu 33: Macro và hàm `inline` khác nhau như thế nào?
...
## Câu 35: `new/delete` và `malloc/free` khác nhau như thế nào?
...
## Câu 36: Mảng và con trỏ khác nhau như thế nào?
...
## Câu 37: `sizeof(mảng)` và `sizeof(con_trỏ)` khác nhau thế nào?
...
## Câu 38: Đa hình compile time và runtime khác nhau như thế nào?
...
## Câu 40: Vì sao không nên mong đợi đa hình khi gọi hàm `virtual` trong constructor hoặc destructor?
...
## Câu 41: `static` trong C/C++ có những cách sử dụng nào?
...
## Câu 42: `extern` trong C/C++ dùng để làm gì?
...
## Câu 43: Declaration và definition khác nhau như thế nào?
...
## Câu 44: `const` khác gì với `#define`?
...
## Câu 45: `typedef` và `using` dùng để làm gì?
...
## Câu 46: `enum` là gì? `enum class` khác `enum` thường như thế nào?
...
## Câu 47: `namespace` trong C++ dùng để làm gì?
...
## Câu 48: `nullptr` khác gì với `NULL`?
...
## Câu 53: `std::vector` khác mảng thông thường như thế nào?
...
## Câu 54: `std::vector` và `std::list` khác nhau như thế nào?
...
## Câu 64: `std::deque` là gì? Khác `vector` thế nào?
...
## Câu 66: `std::sort()` dùng để làm gì?
...
## Câu 67: `std::find()` dùng để làm gì?
...
## Câu 68: Iterator trong STL là gì?
...
## Câu 69: `begin()` và `end()` khác nhau như thế nào?
...
## Câu 70: Iterator khác con trỏ thông thường như thế nào?
...
## Câu 71: Iterator invalidation là gì?
...
## Câu 72: Độ phức tạp quan trọng của `std::vector` là gì?
...
## Câu 73: Độ phức tạp quan trọng của `std::map` là gì?
...
## Câu 74: Độ phức tạp quan trọng của `std::unordered_map` là gì?
...
## Câu 75: Khi nào nên dùng `map`, khi nào nên dùng `unordered_map`?
...
## Câu 76: Cách nhớ nhanh nhóm `set/map`, `multi` và `unordered`?
...
## Câu 77: Chọn container STL nào trong các tình huống thường gặp?
